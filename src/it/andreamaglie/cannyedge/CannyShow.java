...
public class CannyShow extends JApplet {
	...
	public static JLabel kerlabel = new JLabel("Ukuran");
	public static JLabel highlabel = new JLabel("Ambang Atas");
	public static JLabel lowlabel = new JLabel("Ambang Bawah");
	public static JLabel sigmalabel = new JLabel("Simpang Baku");
